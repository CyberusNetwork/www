...
--width 500 \
--height 200 \
--title "Flux IN/OUT sur la sis2 (Reserved) - 1 heure" \
--slope-mode \
--watermark "`date`" \
--color CANVAS#000000 \
--color BACK#333333 \
...
--color SHADEA#404040 \
--color SHADEB#404040 \
DEF:in=/var/www/htdocs/admin/db/netsis2.rrd:in:AVERAGE \
DEF:out=/var/www/htdocs/admin/db/netsis2.rrd:out:AVERAGE \
CDEF:in_bits=in,8,* \
CDEF:out_bits=out,8,* \
...
--width 500 \
--height 200 \
--title "Flux IN/OUT sur la sis2 (Reserved) - 1 jour" \
--slope-mode \
--watermark "`date`" \
--color CANVAS#000000 \
--color BACK#333333 \
...
--width 500 \
--height 200 \
--title "Flux IN/OUT sur la sis2 (Reserved) - 1 semaine" \
--slope-mode \
--watermark "`date`" \
--color CANVAS#000000 \
--color BACK#333333 \
